...
library(janitor)
library(tidyverse)
library(tidytext) #used for exploring data (unnesting authors and keywords)
library(widyr) #used for exploring data (pairwise for keyword co-occurrence)
library(ggraph) #used for exploring data (keyword co-occurrence)
library(igraph) #used for exploring data (keyword co-occurrence)
library(stm)
library(wordcloud) #used for exploring data
```
